...
API_HASH = environ.get('API_HASH', '8564fab8db759bb04b1907bd12ed98ef')
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://ibb.co/1J9KMH2')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8102446291 6085825994 6976744562').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002238603343') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002289024376')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002470486707')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002483828407')).split()]
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'public_Movies_File') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/RM_Movie_Request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/RM_Movie_Flix')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Movies_Adda_725')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'RM_Support_Group') # Support Chat Link Without https:// or @
...
LANGUAGES = ["bangla", "ben", "malayalam", "mal", "tamil", "tam" ,"english", "eng", "hindi", "hin", "telugu", "tel", "kannada", "kan"]
